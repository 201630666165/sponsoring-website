var where = new Array(35);
	...
	where[32]   =   new   comefrom("雄安","雄安");    
	where[33]   =   new   comefrom("香港","香港");    
	where[34]   =   new   comefrom("澳门","澳门");    
	where[35]   =   new   comefrom("台湾","|台北|高雄|台中|台南|屏东|南投|云林|新竹|彰化|苗栗|嘉义|花莲|桃园|宜兰|基隆|台东|金门|马祖|澎湖");    
	where[36]   =   new   comefrom("全国","全国");
	where[37]   =   new   comefrom("其它","|北美洲|南美洲|亚洲|非洲|欧洲|大洋洲");  
	
	var select_key_array = {"请选择省份名":"0", "北京":"1", "上海":"2", "天津":"3", "重庆":"4", "河北":"5", "山西":"6", "内蒙古":"7", "辽宁":"8", "吉林":"9", "黑龙江":"10", "江苏":"11", "浙江":"12", "安徽":"13", "福建":"14", "江西":"15", "山东":"16", "河南":"17", "湖北":"18", "湖南":"19", "广东":"20", "广西":"21", "海南":"22", "四川":"23", "贵州":"24", "云南":"25", "西藏":"26", "陕西":"27", "甘肃":"28", "宁夏":"29", "青海":"30", "新疆":"31", "香港":"32", "澳门":"33", "台湾":"34", "全国":"35", "其它":"36"};
...
//			alert(select_city);
		if(select_province == '' || select_province == null){
			...
			with (document.getElementById("province")) {  
				...
				options[selectedIndex].text = select_province;  
				options[selectedIndex].value   =   select_province;  
			}
			with (document.getElementById("city")) {  
				var loca3 = (where[select_key_array[select_province]].locacity).split("|");  
				var length = loca3.length;  
				for(l=0;l<length;l++)   {
					options[l].text   =   loca3[l];
					options[l].value   =   loca3[l];   
				}  
				if(select_city == '' || select_city == null){
//					loca5 = (where[0].locacity).split("|"); 
//					
//					options[selectedIndex].text = loca5[0];
//					options[selectedIndex].value = loca5[0];
				}else{
					options[selectedIndex].text = select_city;
					options[selectedIndex].value = select_city;
				}
			}
		}
	}  